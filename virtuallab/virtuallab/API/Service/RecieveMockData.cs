...
namespace virtuallab.API.Service
{
    public class RecieveMockData 
    {
        ...
        static RecieveMockData()
        {
            ...
            data2.Add("0,0,0,0,0,0,0,0,11111100,00000000,00000000,00000000");
            data2.Add("1,0,0,0,0,0,0,0,01100000,00000000,00000000,00000000");
            data2.Add("0,1,0,0,0,0,0,0,11011010,00000000,00000000,00000000");
            data2.Add("0,0,1,0,0,0,0,0,11110010,00000000,00000000,00000000");
            data2.Add("0,0,0,1,0,0,0,0,01100110,00000000,00000000,00000000");
            data2.Add("0,0,0,0,1,0,0,0,10110110,00000000,00000000,00000000");
            data2.Add("0,0,0,0,0,1,0,0,10111110,00000000,00000000,00000000");
            data2.Add("0,0,0,0,0,0,1,0,11100000,00000000,00000000,00000000");
            data2.Add("0,0,0,0,0,0,0,1,11111110,00000000,00000000,00000000");
            data2.Add("1,0,0,0,0,0,0,0,11110110,00000000,00000000,00000000");
        }
